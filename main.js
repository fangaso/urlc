let res
  function shorturl() {
	...
	document.getElementById("searchbtn").innerHTML='<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true">请等待</span>';
  ...
  console.log("https://github.com/fangaso/urlc/")
